...
class Robot:
    ...
    def __init__(self, init_pos = [0, 0], topic = '/robot1/mobile_base/commands/velocity'):
        ...
        self.vel_topic = rospy.Publisher(topic, Twist, queue_size=1)
    ...
    def odom_callback(self, data):
        ...
        self.actual_pos[0] = data.pose.pose.position.x + self.init_pos[0]
        self.actual_pos[1] = data.pose.pose.position.y + self.init_pos[1]
    ...
    def face_to_point(self, point, velocity):
        ...
        while abs(orientation_difference) > 0.2:
            print("ANGLE:")
            print(abs(orientation_difference))
            orientation_difference = self.get_difference_angle(point) - self.actual_orientation
